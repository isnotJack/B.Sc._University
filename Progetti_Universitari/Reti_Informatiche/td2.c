                ...
                if(i == 0) {
                    ...
                    //if(volte_autenticazione==0){            
                        ...
                        if(strcmp(buffer,"OK\0")==0){
                            ...
                            if(volte_autenticazione==0) stampa();
                            ...
                            //for(;;){
                                ...
                                printf("com_num %d\n", conto_comande);   
                                    ...
                                    for(ss_com=0; ss_com<volte; ss_com++){
                                        fflush(stdout);
                                        printf("\n LA COMANDA E:%d",com[conto_comande].cod_comanda);
                                        printf("\nIL CODICE E:%s",com[conto_comande].menu_com[ss_com].codice);
